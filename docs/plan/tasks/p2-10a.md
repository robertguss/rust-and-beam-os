...
id: "P2-10a"
linear_id: "ROB-789"
linear_url: "https://linear.app/robert-guss/issue/ROB-789/p2-10a-implement-bounded-byte-streams-and-descriptor-lifecycle"
...
blocks:
  ...
  - "P2-10b"
---
# P2-10a: Implement bounded byte streams and descriptor lifecycle semantics
...
* Use P2-00 synchronization and P2-05b blocking/wakeup primitives. Specify object, endpoint, descriptor, buffer, blocked-reader, and blocked-writer lifetimes separately.
* Account and cap buffers, waiters, descriptors, blocked operations, copied bytes, wakeups, closures, and error paths.
* Expose readiness-state query and change-notification hooks for P2-10b, but do not implement poll registrations in this issue.
...
Done means the stream and descriptor lifecycle is independently correct, bounded, generation-safe, and exposes a stable readiness hook for P2-10b.
