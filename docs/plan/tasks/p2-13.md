...
id: "P2-13"
linear_id: "ROB-717"
linear_url: "https://linear.app/robert-guss/issue/ROB-717/p2-13-run-one-hour-four-vcpu-contention-and-randomized-preemption"
...
blocks:
  ...
  - "P2-14"
---
# P2-13: Run one-hour four-vCPU contention and randomized preemption qualification
...
The official run executes **only** the committed P2-13a manifest. This issue may not choose or revise thresholds after observing results.

* Use the P0-16-selected full-duration runner. Replace the original hard-coded “remote Linux/TCG” requirement if capacity/evidence classification selects native AArch64 KVM or another approved profile; retain TCG as a separate semantic/race companion where useful.
...
Run only on P0-16-approved semantic profiles; define exact liveness/watchdog/resource criteria and preserve first failure.
