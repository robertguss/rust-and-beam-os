...
id: "P2-05a"
linear_id: "ROB-784"
linear_url: "https://linear.app/robert-guss/issue/ROB-784/p2-05a-bring-up-secondary-cpus-per-cpu-state-timers-and-gic-routing"
...
blocks:
  ...
  - "P2-05b"
---
# P2-05a: Bring up secondary CPUs, per-CPU state, timers, and GIC routing
...
* Publish per-CPU readiness with P2-00 synchronization primitives and release secondaries into a diagnostic work loop—not the shared production scheduler yet.
