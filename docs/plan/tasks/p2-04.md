...
id: "P2-04"
linear_id: "ROB-713"
linear_url: "https://linear.app/robert-guss/issue/ROB-713/p2-04-tracking-complete-vma-mapping-protection-and-teardown-semantics"
...
blocks:
  ...
  - "P2-07"
---
# P2-04: Implement brk, mmap, mprotect, munmap, and VM-area accounting
...
* This issue owns the **single-address-space operation semantics and VMA model**. P2-05c owns cross-CPU shootdown, concurrent mutation, and safe remote reclamation before the behavior is Gate-2 complete.
* All mapping operations must call P1-14's common page-table/cache/TLB publication API. No compatibility syscall may manipulate page tables, barriers, or TLBI directly.
...
Split VMA/brk/anonymous mapping, protect/unmap/splitting/rollback, and only admitted file mappings. Block SMP completion on P2-05c.
