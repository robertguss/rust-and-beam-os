...
id: "P3-10"
linear_id: "ROB-731"
linear_url: "https://linear.app/robert-guss/issue/ROB-731/p3-10-audit-upstream-integrity-and-publish-the-central-feasibility"
...
blocks:
  - "GATE-3"
---
# P3-10: Audit upstream integrity and publish the central feasibility evidence
...
* Prove that the official evidence used the exact P0-05 artifact bytes. Diagnostic binaries, symbol-rich rebuilds, instrumented OTP, altered flags, single-scheduler images, host ERTS, qemu-user, 9p/shared folders, host file descriptors, host RPC, or a later rebuilt artifact cannot satisfy the claim.
